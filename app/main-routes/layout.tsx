          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="/main-routes" className="text-gray-200 hover:text-white transition-colors">
                    Home
                  </a>
                </li>
                <li>
                  <a href="/main-routes/products" className="text-gray-200 hover:text-white transition-colors">
                    Products
                  </a>
                </li>
                <li>
                  <a href="/main-routes/about" className="text-gray-200 hover:text-white transition-colors">
                    About Us
                  </a>
                </li>
                <li>
                  <a href="/main-routes/contact" className="text-gray-200 hover:text-white transition-colors">
                    Contact
                  </a>
                </li>
              </ul>
